...
package com.application.food.zxing.maxicode;
...
import com.application.food.zxing.maxicode.decoder.Decoder;
import com.application.food.zxing.BarcodeFormat;
import com.application.food.zxing.BinaryBitmap;
import com.application.food.zxing.ChecksumException;
import com.application.food.zxing.DecodeHintType;
...
public final class MaxiCodeReader implements Reader {
   ...
   * @throws com.application.food.zxing.NotFoundException if a MaxiCode cannot be found
   * @throws com.application.food.zxing.FormatException if a MaxiCode cannot be decoded
   ...
   * case.
   *
   * @see com.application.food.zxing.pdf417.PDF417Reader#extractPureBits(com.application.food.zxing.common.BitMatrix)
   * @see com.application.food.zxing.datamatrix.DataMatrixReader#extractPureBits(com.application.food.zxing.common.BitMatrix)
   * @see com.application.food.zxing.qrcode.QRCodeReader#extractPureBits(com.application.food.zxing.common.BitMatrix)
   */
