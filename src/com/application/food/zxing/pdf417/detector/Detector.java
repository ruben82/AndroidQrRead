...
package com.application.food.zxing.pdf417.detector;
...
public final class Detector {
   ...
   *
   * @return {@link com.application.food.zxing.common.DetectorResult} encapsulating results of detecting a PDF417 Code
   ...
   * @return {@link com.application.food.zxing.common.DetectorResult} encapsulating results of detecting a PDF417 Code
   * @throws com.application.food.zxing.NotFoundException if no PDF417 Code can be found
   */
...
//    Log.v("val", "patternMatchVariance = " + (totalVariance / total));
