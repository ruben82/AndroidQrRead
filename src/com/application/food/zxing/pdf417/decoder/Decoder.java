...
package com.application.food.zxing.pdf417.decoder;
...
public final class Decoder {
   ...
   * @throws com.application.food.zxing.NotFoundException if the PDF417 Code cannot be decoded
   */
  ...
  /**
   * <p>Decodes a PDF417 Code represented as a {@link com.application.food.zxing.common.BitMatrix}.
   * A 1 or "true" is taken to mean a black module.</p>
   *
   * @param bits booleans representing white/black PDF417 Code modules
   * @return text and bytes encoded within the PDF417 Code
   * @throws com.application.food.zxing.FormatException if the PDF417 Code cannot be decoded
   */
  public DecoderResult decode(BitMatrix bits) throws FormatException {
    ...
    Log.v("val", "ecLevel = " + ecLevel );
    
    int numECCodewords = 1 << (ecLevel + 1);
    Log.v("val", "numECCodewords = " + numECCodewords );
   ...
   * @throws com.application.food.zxing.FormatException
   */
