...
package com.application.food.zxing.oned;
...
public final class ITFReader extends OneDReader {
   ...
   * @throws com.application.food.zxing.NotFoundException if decoding could not complete successfully
   */
   ...
   *         'start block'
   * @throws com.application.food.zxing.NotFoundException
   */
   ...
   * @throws com.application.food.zxing.NotFoundException if the quiet zone cannot be found, a ReaderException is thrown.
   */
   ...
   * @throws com.application.food.zxing.NotFoundException Throws exception if no black lines are found in the row
   */
   ...
   *         ints
   * @throws com.application.food.zxing.NotFoundException if pattern is not found
   */
   ...
   * @throws com.application.food.zxing.NotFoundException if digit cannot be decoded
   */
