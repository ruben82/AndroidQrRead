...
public abstract class OneDReader implements Reader {
   ...
   * @throws com.application.food.zxing.NotFoundException Any spontaneous errors which occur
   */
   ...
   * @throws com.application.food.zxing.NotFoundException if counters cannot be filled entirely from row before running out
   *  of pixels
   */
   ...
   * @return {@link com.application.food.zxing.Result} containing encoded string and start/end of barcode
   * @throws com.application.food.zxing.NotFoundException if an error occurs or barcode cannot be found
   */
