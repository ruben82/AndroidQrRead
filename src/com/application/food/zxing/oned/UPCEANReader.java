...
public abstract class UPCEANReader extends OneDReader {
  ...
  /**
   * <p>Like {@link #decodeRow(int, com.application.food.zxing.common.BitArray, java.util.Map)}, but
   ...
   * @throws com.application.food.zxing.FormatException if the string does not contain only digits
   */
