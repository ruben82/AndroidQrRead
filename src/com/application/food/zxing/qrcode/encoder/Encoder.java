...
package com.application.food.zxing.qrcode.encoder;

import com.application.food.zxing.EncodeHintType;
import com.application.food.zxing.WriterException;
import com.application.food.zxing.common.BitArray;
import com.application.food.zxing.common.CharacterSetECI;
import com.application.food.zxing.common.reedsolomon.GenericGF;
import com.application.food.zxing.EncodeHintType;
import com.application.food.zxing.WriterException;
import com.application.food.zxing.common.BitArray;
import com.application.food.zxing.common.reedsolomon.ReedSolomonEncoder;
import com.application.food.zxing.qrcode.decoder.ErrorCorrectionLevel;
import com.application.food.zxing.qrcode.decoder.Mode;
...
public final class Encoder {
   ...
   * if it is Shift_JIS, and the input is only double-byte Kanji, then we return {@link com.application.food.zxing.qrcode.decoder.Mode#KANJI}.
   */
