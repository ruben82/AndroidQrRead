...
package com.application.food.zxing.qrcode.detector;
...
import com.application.food.zxing.common.PerspectiveTransform;
import com.application.food.zxing.DecodeHintType;
import com.application.food.zxing.qrcode.decoder.Version;
import com.application.food.zxing.FormatException;
import com.application.food.zxing.NotFoundException;
import com.application.food.zxing.ResultPoint;
import com.application.food.zxing.ResultPointCallback;
...
public class Detector {
   ...
   *
   * @return {@link com.application.food.zxing.common.DetectorResult} encapsulating results of detecting a QR Code
   * @throws com.application.food.zxing.NotFoundException if no QR Code can be found
   */
   ...
   * @return {@link com.application.food.zxing.NotFoundException} encapsulating results of detecting a QR Code
   * @throws com.application.food.zxing.NotFoundException if QR Code cannot be found
   * @throws com.application.food.zxing.FormatException if a QR Code cannot be decoded
   */
   ...
   * @throws com.application.food.zxing.NotFoundException if an unexpected error occurs during detection
   */
