...
package com.application.food.zxing.aztec.detector;

import com.application.food.zxing.NotFoundException;
import com.application.food.zxing.ResultPoint;
import com.application.food.zxing.aztec.AztecDetectorResult;
import com.application.food.zxing.common.BitMatrix;
import com.application.food.zxing.common.GridSampler;
import com.application.food.zxing.common.detector.WhiteRectangleDetector;
import com.application.food.zxing.common.reedsolomon.GenericGF;
import com.application.food.zxing.NotFoundException;
import com.application.food.zxing.ResultPoint;
import com.application.food.zxing.aztec.AztecDetectorResult;
import com.application.food.zxing.common.BitMatrix;
...
import com.application.food.zxing.common.detector.WhiteRectangleDetector;
import com.application.food.zxing.common.reedsolomon.GenericGF;
import com.application.food.zxing.common.reedsolomon.ReedSolomonDecoder;
import com.application.food.zxing.common.reedsolomon.ReedSolomonException;
import com.application.food.zxing.common.reedsolomon.ReedSolomonDecoder;
import com.application.food.zxing.common.reedsolomon.ReedSolomonException;
...
public final class Detector {
   ...
   *
   * @return {@link com.application.food.zxing.aztec.AztecDetectorResult} encapsulating results of detecting an Aztec Code
   * @throws com.application.food.zxing.NotFoundException if no Aztec Code can be found
   */
   ...
   * @throws com.application.food.zxing.NotFoundException in case of too many errors or invalid parameters
   */
   ...
   * @throws com.application.food.zxing.NotFoundException if the corner points do not fit in the image
   */
   ...
   * @throws com.application.food.zxing.NotFoundException if the array contains too many errors
   */
   ...
   * @throws com.application.food.zxing.NotFoundException If no valid bull-eye can be found
   */
