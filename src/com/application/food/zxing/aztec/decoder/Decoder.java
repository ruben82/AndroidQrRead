...
package com.application.food.zxing.aztec.decoder;
...
public final class Decoder {
   ...
   * @throws com.application.food.zxing.FormatException if the input is not valid
   */
   ...
   * @throws com.application.food.zxing.FormatException if the input contains too many errors
   */
   ...
   * @throws com.application.food.zxing.FormatException if the matrix is not a valid aztec code
   */
