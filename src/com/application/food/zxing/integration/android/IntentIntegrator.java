...
package com.application.food.zxing.integration.android;
...
import com.application.food.zxing.client.android.Intents;
import com.application.food.zxing.BarcodeFormat;
import com.application.food.zxing.client.android.Intents;
...
public class IntentIntegrator {
  ...
  private static final String BS_PACKAGE = "com.application.zxing.client.android";
  ...
  public AlertDialog initiateScan(Collection<String> desiredBarcodeFormats) {
    ...
    if (desiredBarcodeFormats != null) {
      ...
      if( joinedByComma.toString().equals( BarcodeFormat.QR_CODE.toString() ) )
      {
    	  intentScan.putExtra(Intents.Scan.MODE, Intents.Scan.QR_CODE_MODE);
      }
      else if ( joinedByComma.toString().equals( BarcodeFormat.DATA_MATRIX.toString() ) ) 
      {
    	  intentScan.putExtra(Intents.Scan.MODE, Intents.Scan.DATA_MATRIX_MODE);
      }
      else if ( joinedByComma.toString().equals( BarcodeFormat.PDF_417.toString() ) )
      {
    	  intentScan.putExtra(Intents.Scan.MODE, Intents.Scan.PDF417_MODE );
      }
   ...
   // intentScan.setPackage("com.pdf147test");
