...
//  private CheckBoxPreference decodePdf417;
...
//    decodePdf417 = (CheckBoxPreference) preferences.findPreference(KEY_DECODE_PDF417);
  ...
  private void disableLastCheckedPref() {
    ...
    /*if( decodePdf417.isChecked() )
    {
    	checked.add(decodePdf417);
    }*/
    boolean disable = checked.size() < 2;
    CheckBoxPreference[] checkBoxPreferences = {decode1D, decodeQR, decodeDataMatrix/*,decodePdf417*/};
