...
import com.application.food.AfterCaptureActivity;
...
import com.application.food.zxing.client.android.camera.CameraManager;
import com.application.food.zxing.client.android.history.HistoryItem;
import com.application.food.zxing.client.android.history.HistoryManager;
import com.application.food.zxing.client.android.result.ResultHandler;
import com.application.food.zxing.client.android.result.ResultHandlerFactory;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private static final String PACKAGE_NAME = "com.application.zxing.client.android";
    ...
    private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
        ...
        CharSequence displayContents = resultHandler.getDisplayContents(); //Risultato della codifica
        // Eseguo la richiesta HTTP
        Intent i= new Intent(this, AfterCaptureActivity.class);
        i.putExtra("qrcode",displayContents.toString());
