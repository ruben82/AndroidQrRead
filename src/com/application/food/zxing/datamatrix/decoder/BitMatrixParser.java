...
package com.application.food.zxing.datamatrix.decoder;
...
final class BitMatrixParser {
   ...
   * @throws com.application.food.zxing.FormatException if dimension is < 8 or > 144 or not 0 mod 2
   */
   ...
   * 
   * @param bitMatrix Original {@link com.application.food.zxing.common.BitMatrix} including alignment patterns
   * @return {@link Version} encapsulating the Data Matrix Code's "version"
   * @throws com.application.food.zxing.FormatException if the dimensions of the mapping matrix are not valid
  ...
  /**
   * <p>Reads the bits in the {@link com.application.food.zxing.common.BitMatrix} representing the mapping matrix (No alignment patterns)
   * in the correct order in order to reconstitute the codewords bytes contained within the
   * Data Matrix Code.</p>
   *
   * @return bytes encoded within the Data Matrix Code
   * @throws com.application.food.zxing.FormatException if the exact number of bytes expected is not read
   */
  ...
  /**
   * <p>Extracts the data region from a {@link com.application.food.zxing.common.BitMatrix} that contains
   * alignment patterns.</p>
   * 
   * @param bitMatrix Original {@link com.application.food.zxing.common.BitMatrix} with alignment patterns
