...
package com.application.food.zxing.common.detector;
...
public final class MonochromeRectangleDetector {
   ...
   * white, in an image.</p>
   *
   * @return {@link com.application.food.zxing.ResultPoint}[] describing the corners of the rectangular region. The first and
   *  last points are opposed on the diagonal, as are the second and third. The first point will be
   *  the topmost point and the last, the bottommost. The second point will be leftmost and the
   *  third, the rightmost
   * @throws com.application.food.zxing.NotFoundException if no Data Matrix Code can be found
   */
   ...
   *  the barcode
   * @return a {@link com.application.food.zxing.ResultPoint} encapsulating the corner that was found
   * @throws com.application.food.zxing.NotFoundException if such a point cannot be found
   */
